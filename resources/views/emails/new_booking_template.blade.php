                        ...
                        <table role="presentation"
                            ...
                            <tr>
                                <td style="padding:0 0 36px 0;color:#153643;">
                                    ...
                                    <p style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                        <span style="color: red;"> Please do pay now, if you have not already done so and please read our </span>
                                        <span style="color: blue;"><a href=""> Flexible Booking Policy </a></span> <span style="color: red"> before committing to your holiday reservation.</span>
                                    </p>
                                    <p style="margin:10px 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                        Please do pay now, if you have not already done so and please read our
                                        <span style="color: blue;"> <a href=""> SELF SERVICE </a></span> page. If we do not receive a valid payment within two hours of the
                                        booking being made our systems will automatically cancel your reservation, so don't delay!
                                    </p>
                                </td>
                            </tr>
                        </table>
